...
public class Genertor002L04 : MonoBehaviour
{
    ...
    void Update()
    {
        if (IsActive && Input.GetKeyUp(KeyCode.F))
        {
            ...
            if (state % 2 == 0)
            {
                ...
                target3.position = new Vector3(target3.position.x, 5.5f, target3.position.z);
                target4.position = new Vector3(target4.position.x, 5.5f, target4.position.z);
                mate.material.color = Color.white;
            }
            else if (state % 2 != 0)
            {
                ...
                target3.position = new Vector3(target3.position.x, -0.5f, target3.position.z);
                target4.position = new Vector3(target4.position.x, -0.5f, target4.position.z);
